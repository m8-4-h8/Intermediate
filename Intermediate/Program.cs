...
//    Console.WriteLine("New Duration: " + stopwatch.GetDuration());
//}
...
//    myStack.Push(5);
//    myStack.Push("Hello");
//    Console.WriteLine(myStack.Pop()); // Output: Hello
//    myStack.Clear();
//}
//catch (Exception ex)
//{
...
//try
//{
//    DbConnection oracleConnection = new OracleConnection("Oracle Connection String");
//    DbConnection sqlConnection = new SqlConnection("SQL Connection String");

//    // Opening and closing connections
//    PerformConnectionOperations(sqlConnection);
//    PerformConnectionOperations(oracleConnection);
//}
//catch (Exception ex)
//{
//    Console.WriteLine(ex);
//}
//static void PerformConnectionOperations(DbConnection connection)
//{
//    try
//    {
//        connection.OpeningConnection();
//        // Perform operations using the connection (not implemented in this example)
//    }
//    catch (Exception ex)
//    {
...
//    DbConnection oracleConnection = new OracleConnection("Oracle Connection String");
//    DbConnection sqlConnection = new SqlConnection("SQL Connection String");
//    DbCommand dbCommand = new DbCommand(sqlConnection, "SELECT * FROM table");
//    dbCommand.Execute();
//    DbCommand dbCommand2 = new DbCommand(oracleConnection, "SELECT * FROM table");
//    dbCommand2.Execute();
//}
//catch (Exception ex)
//{
...
IActivity activity1 = new Activity1();
IActivity activity2 = new Activity2();
// Создание рабочего процесса (Workflow) и добавление действий в порядке выполнения
Workflow workflow = new Workflow();
workflow.AddActivity(activity1);
workflow.AddActivity(activity2);
// Создание движка рабочего процесса (WorkflowEngine) и запуск рабочего процесса
